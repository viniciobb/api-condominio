...
// http://localhost:3000/api-condominio/enderecos




module.exports.listarEnderecos = function(req, res) {
    ...
    modelEndereco.create(objEndereco,function(err, endereco){
        if(err){
            sendJsonResponse(res, 400, err);
        }else{
            sendJsonResponse(res, 201, endereco);
        }
    });
